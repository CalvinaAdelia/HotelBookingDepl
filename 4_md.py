...
with st.form("booking_form"):
    ...
    no_of_adults = st.number_input("Jumlah Dewasa", min_value=1, max_value=10, key="Jumlah Dewasa")
    no_of_children = st.number_input("Jumlah Anak", min_value=0, max_value=10, key="Jumlah Anak")
    no_of_weekend_nights = st.number_input("Malam Weekend", min_value=0, max_value=10, key="Malam Weekend")
    no_of_week_nights = st.number_input("Malam Weekday", min_value=0, max_value=10, key="Malam Weekday")
    type_of_meal_plan = st.selectbox("Meal Plan", [1, 2, 3], index=[1, 2, 3].index(st.session_state.get("Meal Plan", 1)), key="Meal Plan")
    required_car_parking_space = st.selectbox("Butuh Parkir?", [0, 1], index=[0, 1].index(st.session_state.get("Butuh Parkir?", 0)), key="Butuh Parkir?")
    ...
    market_segment_type = st.selectbox("Segment Pasar", [1, 2, 3, 4, 5, 6, 7], index=[1, 2, 3, 4, 5, 6, 7].index(st.session_state.get("Segment Pasar", 1)), key="Segment Pasar")
